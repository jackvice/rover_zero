...
class TurtleBot3Env(gym.Env, Node):
    def __init__(self,
        ...
        """
        self.latest_imu.angular_velocity.x = 0.0
        self.latest_imu.angular_velocity.y  = 0.0
        self.latest_imu.angular_velocity.z  = 0.0
        self.previous_imu.angular_velocity.x = 0.0
        self.previous_imu.angular_velocity.y = 0.0
        self.previous_imu.angular_velocity.z = 0.0
        self.latest_imu.linear_acceleration.x = 0.0
        self.latest_imu.linear_acceleration.y = 0.0
        self.latest_imu.linear_acceleration.z = 0.0 
        self.previous_imu.linear_acceleration.x = 0.0
        self.previous_imu.linear_acceleration.y = 0.0
        self.previous_imu.linear_acceleration.z = 0.0
        """
    ...
    def calculate_jitter_penalty(self):
        ...
        angular_jitter_threshold = 0.008  # Adjust based on experimentation
        linear_jitter_threshold = 1.8  # Adjust based on experimentation
    
        # Initialize penalty
        penalty = 0
    
        # Apply penalties based on thresholds
        if angular_acceleration_magnitude > angular_jitter_threshold:
            print("Angular jitter penalty: ", angular_acceleration_magnitude, angular_jitter_threshold)
            penalty -= 0.25  # Penalty value, adjust based on experimentation
        
        if linear_acceleration_magnitude > linear_jitter_threshold:
            print("Linear jitter penalty: ", linear_acceleration_magnitude, linear_jitter_threshold)
            penalty -= 0.25  # Penalty value, adjust based on experimentation
