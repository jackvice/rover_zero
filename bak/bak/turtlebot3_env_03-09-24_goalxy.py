...
class TurtleBot3Env(gym.Env, Node):
    def __init__(self, goal_list=None, max_env_size=None, continuous=True):
        ...
        self.num_lidar = 360
        self.observation_size = 372 # 360 lidar + 10 imu and heading and distance
        self.action_size = 2
        self.min_range = 0.00001
        self.max_range = 11.0 #lidar max range is 3.8
    ...
    def _getGoalDistace(self):
        ...
        if current_time - self.start_time >= 60:  # 60 seconds = 1 minute
            ...
            self.goalbox_distance = goal_distance
    ...
    def create_observation_space(self):
        ...
        goal_location_space = spaces.Box(low=-50, high=+50, shape=(2,), dtype=np.float32)
        # Combine these spaces into a Dict space
        observation_space = spaces.Dict({
            "lidar": lidar_space,
            "imu": imu_space,
            #"camera": camera_space,
            "goal": goal_location_space
        })
    ...
    def calculate_reward(self, action, obs_next, previous_imu_state=None):
        ...
        goal_distance_multiplier = 100.0
        goal_angle_multiplier = 10.0
        safe_distance_multiplier = 10.0
        #heading_multiplier = 0.5
        stability_metric_multiplier = 0.85
        smoothness_metric_multiplier = 0.175
