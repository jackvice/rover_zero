...
def parse_args():
    ...
    parser.add_argument("--total-timesteps", type=int, default=9000000, #500000,
...
if __name__ == "__main__":
    ...
    #envs.single_observation_space["state"] = np.array(envs.single_observation_space["state"])
    print(envs.single_observation_space["state"])
    my_test = 3
    #exit()
    rb = DictReplayBuffer(
        args.buffer_size,
        gym.spaces.Dict(envs.single_observation_space),
    ...
    for global_step in range(args.total_timesteps):
        ...
        #print(obs, real_next_obs, actions, rewards, dones, infos)
        #exit()
