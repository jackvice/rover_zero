...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="LunarLanderContinuous-v2", #"default="HalfCheetah-v4",
...
def make_Vec_env_nasium(env_id, idx, capture_video, run_name, gamma):
    def thunk():
        if capture_video:
...
if __name__ == "__main__":
    ...
    envs = make_env(args.env_id, args.seed + 1, 1, args.capture_video, run_name, args.gamma)
