...
def parse_args():
    ...
    if ROVER:
        parser.add_argument("--env-id", type=str, default="RoverZero-v0",
...
if __name__ == "__main__":
    ...
    #envs = gym.vector.SyncVectorEnv( make_env(args.env_id, 0, args.capture_video,
    #run_name, args.gamma ) )
    ...
    if CHECKPOINT:
        ...
        agent.eval()
        print(" ")
        print(f"resumed at update {global_step} steps")
