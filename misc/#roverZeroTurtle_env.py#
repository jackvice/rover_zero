...
from gym_rover.envs.mytf import euler_from_quaternion
...
class RoverZeroEnv(gym.Env):
    ...
    def take_observation(self):
        ...
        self.position = msg.transforms[0].transform.translation
        z_position = msg.transforms[0].transform.translation
