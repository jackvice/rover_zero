...
def perform_environment_steps(next_obs, next_done, args, envs, agent, device, writer, global_step,
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        advantages, returns = calculate_advantages_and_returns(args, next_obs, agent, device, dones, rewards, values)
