...
def make_env(env_id, idx, capture_video, run_name, gamma):
    #def thunk():
        if capture_video:
            ...
            env = gym.make(env_id)
            #env = PixelObservationWrapper(gym.make(env_id))
        #print('1', env.__dir__(),
        #      'dir', dir(env))
        #exit()
...
if __name__ == "__main__":
    ...
    ##
    #print("envs.single_observation_space.shape", envs.observation_space.shape)
    print("envs.single_observation_space.shape", envs.observation_space.shape)
    #exit()
    ##
    ...
    #print('args.num_steps', args.num_steps, 'args.num_envs', args.num_envs, 'envs.observation_space.shape',
